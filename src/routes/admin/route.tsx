...
import { LayoutDashboard, Users, FileQuestion, Settings, LogOut, Menu, Sparkles, Beaker, History } from "lucide-react";
...
function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: "Log Aktivitas", to: "/admin/log-aktivitas", icon: History },
