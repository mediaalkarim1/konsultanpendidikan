...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Konsultasi & Rekomendasi Pendidikan Untuk Anak" },
      { property: "og:description", content: "Temukan rekomendasi pendidikan terbaik sesuai jenjang pendidikan anak." },
